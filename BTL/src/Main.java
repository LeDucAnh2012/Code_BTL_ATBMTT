...
public class Main {
    ...
    public static int[] Decode(String BANMA, String K_KEY){
        ...
        for (int i = 0; i < L_Decode.length; i++) {
            L_Decode[i] = arraytmp_BANMA[i];
        }
        ...
        for(int t = 0; t < 16 ;t++){
            for(int t1 = 0 ; t1 < 48 ; t1 ++){
                tmpKey_Decode[t][t1] = arrayKey[15-t][t1];
            }
        }
    ...
    public static void main(String[] args) {
        ...
        // Tao Label
        Font newfont= new Font("DucAnh",20,30);
        Label labDES = new Label("DES");
        labDES.setFont(newfont);
        labDES.setBounds(200,30,200,50);
...
//        DBConnection conn = new DBConnection();
        ...
        labChuoiBinary.setBounds(50,700,150,30);
